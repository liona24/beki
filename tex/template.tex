...
\lfoot{\vbox to 0.3cm{\includegraphics[height=1cm]{../logo.png}}}
\rfoot{\today \\ Seite \thepage/\pageref{LastPage}}
...
\begin{document}
	...
	\begin{tabular}{l l}
		Prüfgrundlagen: & \parbox[t]{9cm}{\VAR{overview}}\\
	\end{tabular}
			...
			& \multicolumn{2}{>{\hsize=\dimexpr2\hsize+2\tabcolsep+\arrayrulewidth\relax}X|}{
				\BLOCK{ if flaw['picture'] }
					\begin{minipage}[t]{0.6\textwidth}
						\textit{Befund/Mangel:} \VAR{flaw['title']}\newline
